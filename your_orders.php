                    ...
                    <div class="row">
						...
						$query_res= mysqli_query($db,"select * from users_orders where u_id='".$_SESSION['user_id']."'");
												if(!mysqli_num_rows($query_res) > 0 )
														{
															echo '<td colspan="6"><center>Riwayat Pemesanan kamu masih kosong, nih. Pesan yuk? </center></td>';
														}
													else
														{			      
							...
							?>
												<tr>	
														 <td data-column="Item"> <?php echo $row['title']; ?></td>
														  ...
														  <td data-column="price">IDR<?php echo $row['price']; ?></td>
														   ...
														   <?php 
																		   ...
																		   <?php 
																			 ...
																			 { ?>
																				<button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin"  aria-hidden="true" ></span> Sedang Diantarkan</button>
																			<?php
																				}
																			if($status=="closed")
																				{
														  ...
														  <td data-column="Date"> <?php echo $row['date']; ?></td>
														   <td data-column="Action"> <a href="delete_orders.php?order_del=<?php echo $row['o_id'];?>" onclick="return confirm('Apakah kamu yakin ingin membatalkan pesanan?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
															</td>
