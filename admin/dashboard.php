            ...
            <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Beranda Admin</h4>
                            </div>
                     <div class="row">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from restaurant";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Jumlah Restoran</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from users";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Jumlah Pengguna</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from res_category";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Kategori Restoran</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php 
                                        ...
                                        echo $sum;
                                        ?></h2>
                                    <p class="m-b-0">Jumlah Pendapatan</p>
                                </div>
                            </div>
                        </div>
                    </div>
