            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a href="all_users.php">  <span><i class="fa fa-user f-s-20 "></i></span><span>Data Pengguna</span></a></li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Data restoran</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_restaurant.php">Daftar Restoran</a></li>
								<li><a href="add_category.php">Tambah Kategori</a></li>
                                <li><a href="add_restaurant.php">Tambah Restoran</a></li>
                                
                            </ul>
                        </li>
                      <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Data Menu</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_menu.php">Daftar Menu</a></li>
								<li><a href="add_menu.php">Tambah Menu</a></li>
                              
                                
                            </ul>
                        </li>
						 <li> <a href="all_orders.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span>Data Pesanan</span></a></li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Lihat Detail Pesanan</h4>
                            </div>
                                        ...
                                        <tbody>
                                           <?php
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['username']; ?></center></td>
													   ...
													   <a href="javascript:void(0);" onClick="popUpWindow('order_update.php?form_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
															 <button type="button" class="btn btn-primary">Ubah Status Pesanan</button></a>
															 </center>
											 </td>
											...
											<tr>
												    ...
												    <td><center>IDR <?php echo $rows['price']; ?></center></td>
											...
											<tr>
													...
													<?php 
																			...
																			{
																			?>
																			<td> <center><button type="button" class="btn btn-info"><span class="fa fa-bars"  aria-hidden="true" ></span> Diproses</button></center></td>
																		   <?php 
																			  }
