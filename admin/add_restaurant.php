                                ...
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">Email Restoran</label>
                                        ...
                                        <div class="row">
											...
											<div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">Foto Restoran</label>
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Pilih Kategori Restoran</label>
                                        ...
                                        <h3 class="box-title m-t-40">Alamat Restoran</h3>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
